...
from roosterize.ml.onmt.MultiSourceNMTModel import MultiSourceNMTModel
import onmt
from onmt.decoders import DecoderBase
from onmt.encoders import str2enc, EncoderBase
...
class MultiSourceModelBuilder:
    ...
    @classmethod
    def build_encoder(cls, opt, embeddings):
        """
